            ...
            else if (Game.IsControlJustReleased(0, Control.Attack))
            {
                ...
                if (_raycastResult.DitHit)
                {
                    ...
                    else
                    {
                        ...
                        Debug.WriteLine(string.Format("{0}, {1}, {2}", _raycastResult.HitPosition, $"new Vector3({_raycastResult.HitPosition.X}f, {_raycastResult.HitPosition.Y}f, {_raycastResult.HitPosition.Z}f)", JsonConvert.SerializeObject(_raycastResult.HitPosition)));
                    }
                }
